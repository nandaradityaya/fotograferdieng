...
(function ($) {
  ...
  $(".scroll-to").on("click", function (e) {
    ...
    // Ambil target section berdasarkan href
    var target = $(this).attr("href");

    // Scroll ke target section
    $("html, body").animate(
      {
        scrollTop: $(target).offset().top, // Dapatkan offset dari section
      },
      600 // Durasi animasi dalam milidetik
    );
  ...
  $(".menu-mobile > li > .sub-menu > li:has(ul.sub-menu)").addClass(
    "menu-item-parent-2level"
  );
